...
const PageCreate = () =>{
    return(
        <div> 
        <Link href={"/home"}><button className="bg-gradient-to-r from-green-400 to-green-200 hover:scale-105 drop-shadow-md  shadow-cla-blue px-4 py-1 rounded-lg">Volver al Home</button></Link>
  ...
  <div className="w-full rounded-xl bg-white p-4 shadow-2xl shadow-white/40">
    ...
    <div className="flex">
      ...
      <label htmlFor="privacy" className="mb-2 ">
        ...
        <div className="w-6 h-6  items-center inline-block justify-center hover:border-blue-500 focus:ring transition-all focus:ring-blue-500/40 border border-slate-200 rounded-lg peer-checked:bg-blue-500 peer-checked:[&>svg]:block [&>svg]:hidden">
        ...
        <Link href={"/home"}><button className="bg-gradient-to-r from-gray-400 to-gray-200 hover:scale-105 drop-shadow-md  shadow-cla-blue px-4 py-1 rounded-lg">Next</button></Link>
